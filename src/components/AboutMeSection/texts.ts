export const subsectionsList = [
  {
    title: 'Pessoal',
    description: `Contando um pouco sobre mim, sou de São José dos Campos, SP, gosto de ficar em casa com minha família, jogar online com amigos, cuidar dos meus pets (gatos e cachorros) e viajar de vez em quando.
